...
/*1a00*/ {{0x1L, 0x91300120L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L}},
/*1f80*/ 0x0000L,
/*2100*/ {0x0L},
/*2101*/ 0x30L,
/*2102*/ 0xfa,
...
{0x9130, 0x01, 0xfe, 4, (void*)&CO_OD_RAM.AI_PV32Bit[0]},
};
