...
/*******************************************************************************
   FILE INFO:
      FileName:     TemperatureSensor.eds
      FileVersion:  1
      CreationTime: 1:06PM
      CreationDate: 12-13-2017
      CreatedBy:    Stefan Seifried
******************************************************************************/


/*******************************************************************************
   DEVICE INFO:
      VendorName:     ASG TU Wien
      VendorNumber    294
...
/*9130 */
        #define OD_9130_AI_PV32Bit                                  0x9130

        #define OD_9130_0_AI_PV32Bit_maxSubIndex                    0
        #define OD_9130_1_AI_PV32Bit_AI_PV32Bit1                    1
...
/*9130, Data Type: INTEGER32, Array[1] */
        #define OD_AI_PV32Bit                                       CO_OD_RAM.AI_PV32Bit
        #define ODL_AI_PV32Bit_arrayLength                          1
        #define ODA_AI_PV32Bit_AI_PV32Bit1                          0
